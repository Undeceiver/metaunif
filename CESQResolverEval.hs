...
cesqquery4_1 = read "|= [[+P1[1](f5[0]())]]"

cesqquery4_2 :: SOMetaBaseQ
cesqquery4_2 = read "|= [[-k1[1]([[+P1[1]]])]]"

cesqquery4 :: SOMetaQuery
cesqquery4 = (BaseQ (read "[?P1[1]]") cesqquery4_1) $<= (BaseQ (read "[?P1[1]]") cesqquery4_2) $ (fromList [(read "P1[1]",(! (read "P1[1]")))])
